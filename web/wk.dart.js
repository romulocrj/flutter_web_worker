...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    WkAction: function WkAction() {
    },
    main() {
      self.onmessage = A.allowInterop(new A.main_closure(), type$.Null_Function_dynamic);
    },
  ...
  A.main_closure.prototype = {
    call$1($event) {
      ...
      if (J.$eq$(t1.get$kind(action), "start")) {
        ...
        if (typeof t1 !== "number")
          return t1.$add();
        self.postMessage({kind: "end", value: t1 + 1});
      }
    },
    $signature: 6
  };
  ...
  (function inheritance() {
    ...
    _inheritMany(J.LegacyJavaScriptObject, [J.PlainJavaScriptObject, J.UnknownJavaScriptObject, J.JavaScriptFunction, A.WkAction, A.MessageEvent]);
...
//# sourceMappingURL=wk.dart.js.map
